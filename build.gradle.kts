...
dependencies {
    setOf("ktx-app", "ktx-assets", "ktx-log", "ktx-box2d", "ktx-graphics").forEach{
...
application.mainClass.set("io.github.alexlettuce.game.Entrypoint")

java.toolchain.languageVersion.set(of(17))

tasks {
    jar { manifest.attributes("Main-Class" to "io.github.alexlettuce.game.Entrypoint") }
    shadowJar { archiveFileName.set("../Game.jar") }
